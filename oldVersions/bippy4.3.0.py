#Aaron Perkel - delete later
#Bippy V4.3.0 (03/31/21 19:33:16)
...
pg.display.set_caption('Bippy V4.3.0') # window title
...
class Object: # class to handle objects
    def __init__(self, inputScreen): # initialize class
        ...
        self.xLoc = random.randint(660, 1260)
        for i in objects:
            while abs(self.xLoc - i.xLoc) < 48:
                self.xLoc += 1
...
restart = font.render('RESTART', True, 0)
